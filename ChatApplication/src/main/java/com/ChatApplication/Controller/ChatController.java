 ...
 public class ChatController {
    ...
    public  void  sendMessage( ChatMessagesModel incomingMessage) {
        ...
        try {
            ...
            // save the ai response (use the ChatService method that persists assistant replies)
            ...
            // Fix: NPEs have a null message, so e.getMessage() is null. We must handle this so the client doesn't see "Server error: null"
